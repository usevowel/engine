...
This project is indexed by GitNexus as **engine** (5141 symbols, 10112 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
